...
def admin_dashboard_view(request):
    dict={
        ...
        'total_moneda':models.Moneda.objects.all().count(),
...
def admin_view_moneda_view(request):
    categories = models.Moneda.objects.all()
    return render(request,'insurance/admin_view_moneda.html',{'categories':categories})

def admin_delete_moneda_view(request):
    categories = models.Moneda.objects.all()
    return render(request,'insurance/admin_delete_moneda.html',{'categories':categories})
